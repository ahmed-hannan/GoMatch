...
class Car1 extends StatefulWidget {
  ...
  @override
  State<Car1> createState() => Car1State();
}

class Car1State extends State<Car1> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text('Press the icon to select this'
    ...
    return Scaffold(
      ...
      Positioned(
        ...
        child: IconButton(
              ...
              icon: (carModel.isBooked && carModel.carChosen ==1)? SizedBox(
                 width: 150,
                height: 150,
